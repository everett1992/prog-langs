...
pzls = [
  ...
  [
    nil, nil, nil, nil, nil, 9, "B", nil, nil, 2, nil, nil, "D", 5, "A", nil,
    9, 1, nil, 4, nil, nil, 3, nil, "A", nil, 7, nil, nil, nil, "C", nil,
    "B", nil, nil, 2, nil, nil, "A", nil, nil, 9, nil, nil, nil, nil, 3, nil,
    "C", nil, nil, nil, "D", nil, nil, 1, 8, nil, "B", "F", nil, 4, 6, nil,
    nil, nil, nil, nil, "B", "D", nil, "G", 3, nil, 6, "A", 7, nil, nil, nil,
    nil, "F", nil, "B", 8, "C", nil, nil, "D", "G", 9, 7, nil, nil, nil, 1,
    3, nil, "A", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, 2, 4, 6,
    6, 7, nil, 5, 4, 3, nil, nil, nil, nil, nil, nil, 8, nil, nil, nil,
    nil, nil, nil, 8, 7, nil, nil, nil, nil, nil, "A", 9, "F", nil, 1, 3,
    "G", 2, 3, nil, nil, nil, nil, nil, nil, nil, 5, nil, nil, "C", nil, "A",
    4, nil, nil, nil, 3, "G", 1, "F", nil, nil, 2, 8, 9, nil, 5, nil,
    nil, nil, nil, 1, 5, "A", nil, 6, 4, nil, 3, "G", "B", nil, nil, nil,
    nil, 6, "B", nil, 2, 1, nil, 3, 5, nil, nil, 4, nil, nil, nil, "F",
    nil, 3, nil, nil, nil, nil, 9, nil, nil, 1, nil, nil, 5, nil, nil, 4,
    nil, 5, nil, nil, nil, "F", nil, 4, nil, "B", nil, nil, 3, 8, 2, "C",
    nil, 4, 2, "F", nil, nil, "D", "B", nil, 7, 8, nil, nil, nil, nil, nil,
...
Benchmark.bm do |bm|
  pzls.reverse.take(1).each_with_index do |ss, n|
    bm.report do
      puts
      puts "-- puzzle #{n}"
